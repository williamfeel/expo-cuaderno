...
import { type Transaccion } from "@/interfaces/interfaces";
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.row}>
        <MyButtonMovimiento setTipoActual={setTipoActual} tipoActual={tipoActual} tipo="Préstamo" />
        <MyButtonMovimiento setTipoActual={setTipoActual} tipoActual={tipoActual} tipo="Devolución" />
        <MyButtonMovimiento setTipoActual={setTipoActual} tipoActual={tipoActual} tipo="Otro" />
      </View>
      <Formik
        ...
        onSubmit={(values, { resetForm }) => {
          ...
          const respuesta = addTransaccion(newValues)
          respuesta.then(e => setRes(e))
          resetForm()
              ...
              <TouchableOpacity
                ...
                onPress={async () => {
                  try {
                    ...
                    if (vale || (indexTipo !== -1)) { handleSubmit(), setIsLoadingAdd(true), setModalVisible(true) }
